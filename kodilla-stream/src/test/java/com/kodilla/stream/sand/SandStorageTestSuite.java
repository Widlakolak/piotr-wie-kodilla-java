...
class SandStorageTestSuite {
    ...
    void testGetSandBeansQuantityWithReduce() {
        ...
        //Given
        List<SandStorage> continentals = new ArrayList<>();
        continentals.add(new Europe());
        continentals.add(new Asia());
        continentals.add(new Africa());

        //When
        BigDecimal totalSand = continentals.stream()
